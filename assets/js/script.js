$("document").ready(function () {
  ...
  $("form").submit(function (event) {
    ...
    // SE VALIDA NO INGRESAR UN NUMERO MAYOR A 731, YA QUE ESA ES LA CANTIDAD DE HEROES
    if (valueInput > 731) {
    ...
    <div class="row">
      <div class="col-md-4 my-auto text-center ">
        <img id="heroeImg" src="${imagen}" height="350px" />
      </div>
      <div class="col-md-4">
        <div class="card-body">
      ...
      <div class="col-md-4">
        <div id="heroeStats" style="height: 360px; width: 100%"></div>
      </div>
    </div>
  </div>
        `);

        // METODO PARA INGRESAR DATOS EN LA ESTADISTICA DEL CHART DE CANVAS
